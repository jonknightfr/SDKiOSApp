...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FRAuthenticator/FRAuthenticator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FRCore/FRCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FRDeviceBinding/FRDeviceBinding.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FRFacebookSignIn/FRFacebookSignIn.framework"
